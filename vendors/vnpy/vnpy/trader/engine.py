...
class MainEngine:
    ...
    def add_engine(self, engine_class: type[EngineType], engine_name: str) -> EngineType:
        """
        Add function engine.
        """
        engine: EngineType = engine_class(self, self.event_engine, engine_name)
    ...
    def add_app(self, app_class: type[BaseApp]) -> BaseEngine:
        ...
        Add app.
        """
        app: BaseApp = app_class(self, self.event_engine)
        self.apps[app.app_name] = app

        engine: BaseEngine = self.add_engine(app.engine_class, app.app_name)
        return engine
    ...
    def init_engines(self) -> None:
        ...
        Init all engines.
        """
        self.add_engine(LogEngine, "log")

        oms_engine: OmsEngine = self.add_engine(OmsEngine, "oms")
        ...
        email_engine: EmailEngine = self.add_engine(EmailEngine, "email")
