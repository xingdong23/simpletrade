        ...
        <div v-if="backtestResultDisplay.hasResult" style="margin-top: 20px;">
            <el-divider content-position="left">回测结果 (记录 ID: {{ backtestResultDisplay.record_id }})</el-divider>
             <el-row :gutter="20" style="margin-bottom: 20px;">
               ...
               <el-col :span="6"><el-card shadow="hover"><div style="text-align: center;"><h3 class="result-title">最大回撤率</h3><p class="result-value negative">{{ formatPercent(backtestResultDisplay.statistics.max_ddpercent) }}</p></div></el-card></el-col>
